...
@Composable
fun ChannelItemDesign ( channel : Channels){
...
var isFollowing by remember {
    ...
    Row (
        modifier = Modifier.fillMaxWidth().padding(horizontal = 12.dp ,
            vertical = 8.dp),verticalAlignment = Alignment.CenterVertically
    )
    {
        Image(painter = painterResource(id = channel.image), contentDescription = null , modifier = Modifier.size(60.dp).padding(4.dp))
